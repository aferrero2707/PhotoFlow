...
macro (libfind_pkg_check_modules)
  message("libfind_pkg_check_modules:")
  message("    PKG_CONFIG:            " $ENV{PKG_CONFIG})
  ...
  if (PKG_CONFIG_FOUND)
    message("pkg_check_modules(" ${ARGN} ")")
...
function (libfind_pkg_detect PREFIX)
  ...
  # Find library
  message("libfind_pkg_check_modules(" ${PREFIX} "_PKGCONF " ${pkgargs} ")" )
