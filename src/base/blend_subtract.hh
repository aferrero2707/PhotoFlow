...
class BlendSubtract: public BlendBase<T, colorspace, CHMIN, CHMAX, has_omap>
{
public:
...
class BlendSubtract<T, CS, CHMIN, CHMAX, false>:
...
template<typename T, colorspace_t CS, int CHMIN, int CHMAX>
class BlendSubtract<T, CS, CHMIN, CHMAX, true>:
...
class BlendSubtract<float, CS, CHMIN, CHMAX, false>:
...
class BlendSubtract<T, PF_COLORSPACE_GRAYSCALE, CHMIN, CHMAX, false>:
...
template<typename T, int CHMIN, int CHMAX>
class BlendSubtract<T, PF_COLORSPACE_GRAYSCALE, CHMIN, CHMAX, true>:
...
class BlendSubtract<float, PF_COLORSPACE_GRAYSCALE, CHMIN, CHMAX, false>:
...
template<int CHMIN, int CHMAX>
class BlendSubtract<float, PF_COLORSPACE_GRAYSCALE, CHMIN, CHMAX, true>:
