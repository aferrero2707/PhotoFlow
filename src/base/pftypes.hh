...
namespace PF
{
  ...
  enum BandFormat {
    PF_BANDFMT_UCHAR = VIPS_FORMAT_UCHAR,
    PF_BANDFMT_CHAR = VIPS_FORMAT_CHAR,
    PF_BANDFMT_USHORT = VIPS_FORMAT_USHORT,
    PF_BANDFMT_SHORT = VIPS_FORMAT_SHORT,
    PF_BANDFMT_UINT = VIPS_FORMAT_UINT,
    PF_BANDFMT_INT = VIPS_FORMAT_INT,
    PF_BANDFMT_FLOAT = VIPS_FORMAT_FLOAT,
    PF_BANDFMT_DOUBLE = VIPS_FORMAT_DOUBLE,
    PF_BANDFMT_UNKNOWN
  };
