...
class BlendLighten<T, CS, CHMIN, CHMAX, false>: 
...
template<typename T, colorspace_t CS, int CHMIN, int CHMAX>
class BlendLighten<T, CS, CHMIN, CHMAX, true>: 
...
class BlendLighten<T, PF_COLORSPACE_GRAYSCALE, CHMIN, CHMAX, false>: 
...
template<typename T, int CHMIN, int CHMAX>
class BlendLighten<T, PF_COLORSPACE_GRAYSCALE, CHMIN, CHMAX, true>: 
