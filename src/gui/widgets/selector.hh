...
namespace PF {
  ...
  public:
    Selector(OperationConfigGUI* dialog, std::string pname, std::string l, int val, int width=100);
    Selector(OperationConfigGUI* dialog, ProcessorBase* processor, std::string pname, std::string l, int val, int width=100);
