...
#ifndef GMIC_EMULATE_FILM_VARIOUS_CONFIG_DIALOG_HH
#define GMIC_EMULATE_FILM_VARIOUS_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class GmicEmulateFilmVariousConfigDialog: public OperationConfigDialog
  {
  ...
  public:
    GmicEmulateFilmVariousConfigDialog( Layer* l );
