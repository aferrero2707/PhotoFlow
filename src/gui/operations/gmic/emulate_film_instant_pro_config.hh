...
#ifndef GMIC_EMULATE_FILM_INSTANT_PRO_CONFIG_DIALOG_HH
#define GMIC_EMULATE_FILM_INSTANT_PRO_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class GmicEmulateFilmInstantProConfigDialog: public OperationConfigDialog
  {
  ...
  public:
    GmicEmulateFilmInstantProConfigDialog( Layer* l );
