...
PF::GmicGradientNormConfigDialog::GmicGradientNormConfigDialog( PF::Layer* layer ):
  ...
  prop_min_threshold_slider( this, "min_threshold", "min_threshold", 0, 0, 100, 1.00, 10.0, 1),
  prop_max_threshold_slider( this, "max_threshold", "max_threshold", 100, 0, 100, 1.00, 10.0, 1)
{
