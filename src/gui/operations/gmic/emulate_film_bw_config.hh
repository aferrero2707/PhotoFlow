...
#ifndef GMIC_EMULATE_FILM_BW_CONFIG_DIALOG_HH
#define GMIC_EMULATE_FILM_BW_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class GmicEmulateFilmBEConfigDialog: public OperationConfigDialog
  {
  ...
  public:
    GmicEmulateFilmBEConfigDialog( Layer* l );
