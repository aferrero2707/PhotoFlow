...
#ifndef GMIC_EMULATE_FILM_INSTANT_CONSUMER_CONFIG_DIALOG_HH
#define GMIC_EMULATE_FILM_INSTANT_CONSUMER_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class GmicEmulateFilmInstantConsumerConfigDialog: public OperationConfigDialog
  {
  ...
  public:
    GmicEmulateFilmInstantConsumerConfigDialog( Layer* l );
