...
#ifndef GMIC_EMULATE_FILM_COLORSLIDE_CONFIG_DIALOG_HH
#define GMIC_EMULATE_FILM_COLORSLIDE_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class GmicEmulateFilmColorslideConfigDialog: public OperationConfigDialog
  {
  ...
  public:
    GmicEmulateFilmColorslideConfigDialog( Layer* l );
