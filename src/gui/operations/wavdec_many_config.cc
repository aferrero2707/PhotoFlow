 ...
 */
#include "../../operations/wavdec_many.hh"

#include "wavdec_many_config.hh"


PF::WavDecManyConfigGUI::WavDecManyConfigGUI( PF::Layer* layer ):
  OperationConfigGUI( layer, "Multi-Scale Decomposition"  ),
  blur_type_selector( this, "blur_type", _("blur type: "), PF::WAVDEC_MANY_BLUR_GAUSS ),
