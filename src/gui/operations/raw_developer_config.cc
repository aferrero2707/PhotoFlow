...
PF::RawDeveloperConfigGUI::RawDeveloperConfigGUI( PF::Layer* layer ):
  ...
  saturationLevelSlider( this, "saturation_level_correction", _("RAW white level %"), 0, -100, 100, 0.5, 5, 100 ),
  blackLevelSlider( this, "black_level_correction", _("RAW black level %"), 0, -100, 100, 0.5, 5, 100 ),
