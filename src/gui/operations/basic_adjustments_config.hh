...
#ifndef BASIC_ADJUSTMENTS_CONFIG_DIALOG_HH
#define BASIC_ADJUSTMENTS_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class BasicAdjustmentsConfigGUI: public OperationConfigGUI
{
...
public:
  BasicAdjustmentsConfigGUI( Layer* l );
