...
#ifndef LOCAL_CONTRAST_CONFIG_DIALOG_HH
#define LOCAL_CONTRAST_CONFIG_DIALOG_HH

#include <gtkmm.h>

#include "../operation_config_gui.hh"
#include "../../operations/local_contrast.hh"
#include "../widgets/vslider.hh"


namespace PF {

  class LocalContrastConfigGUI: public OperationConfigGUI
  {
  ...
  public:
    LocalContrastConfigGUI( Layer* l );
