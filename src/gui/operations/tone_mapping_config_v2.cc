...
static double LE_gain_slider_to_prop(double& val, PF::OperationConfigGUI*, void*)
{
  return pow(2,val);
}

static double LE_gain_prop_to_slider(double& val, PF::OperationConfigGUI*, void*)
{
  return log(val)/log(2);
}


static double LE_max_slider_to_prop(double& val, PF::OperationConfigGUI*, void*)
{
  return pow(2,val);
}

static double LE_max_prop_to_slider(double& val, PF::OperationConfigGUI*, void*)
{
  return log(val)/log(2);
}
