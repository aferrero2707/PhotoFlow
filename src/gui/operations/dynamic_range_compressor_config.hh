...
#ifndef DYNAMIC_RANGE_COMPRESSOR_CONFIG_DIALOG_HH
#define DYNAMIC_RANGE_COMPRESSOR_CONFIG_DIALOG_HH
...
namespace PF {
  ...
  class DynamicRangeCompressorConfigGUI: public OperationConfigGUI
  {
  ...
  public:
    DynamicRangeCompressorConfigGUI( Layer* l );
