...
class RawHistogramArea : public Gtk::DrawingArea
{
public:
  ...
  ulong_p hist;
  float black, white;
  bool zoom_black, zoom_white;

  RawHistogramArea(): hist(NULL) {}
...
class RawDeveloperConfigGUI: public OperationConfigGUI
{
  ...
  Gtk::VBox histogramBox;
  RawHistogramArea histogramArea;
  Gtk::HBox histogramCtrlBox;
  Gtk::Label hist_range_label;
  Gtk::Label hist_range_full_label;
  Gtk::Label hist_range_sh_label;
  Gtk::Label hist_range_hi_label;
  Gtk::RadioButton hist_range_full_check;
  Gtk::RadioButton hist_range_sh_check;
  Gtk::RadioButton hist_range_hi_check;
  bool histogram_range_full;
  bool histogram_range_sh;
  bool histogram_range_hi;
...
public:
  ...
  void on_histogram_radio_group_changed();
