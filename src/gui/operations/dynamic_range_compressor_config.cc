...
PF::DynamicRangeCompressorConfigGUI::DynamicRangeCompressorConfigGUI( PF::Layer* layer ):
  ...
  strength_slider( this, "strength", "strength", 0, 0, 100, 0.5, 5, 1),
  ...
  bilateralSigmasSlider( this, "bilateral_sigma_s", "coarseness", 25, 0, 100, 0.1, 1, 10),
  bilateralSigmarSlider( this, "bilateral_sigma_r", "edge threshold", 20, 0, 100, 0.1, 1, 1)
{
  ...
  controlsBox.pack_start( strength_slider, Gtk::PACK_SHRINK, 2 );
