...
#include "gmic.hh"
#include "smooth_mean_curvature.hh"



PF::GmicSmoothMeanCurvaturePar::GmicSmoothMeanCurvaturePar(): 
OpParBase(),
//iterations("iterations",this,1),
  prop_iterations("iterations",this,4),
  prop_time_step("time_step",this,30)
{	
  gmic = PF::new_gmic();
  set_type( "gmic_smooth_mean_curvature" );
}
...
PF::ProcessorBase* PF::new_gmic_smooth_mean_curvature()
{
  return( new PF::Processor<PF::GmicSmoothMeanCurvaturePar,PF::GmicSmoothMeanCurvatureProc>() );
}
