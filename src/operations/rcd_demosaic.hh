...
#ifndef RCD_DEMOSAIC_H
#define RCD_DEMOSAIC_H
...
namespace PF
{
  ...
  class RCDDemosaicPar: public OpParBase
  {
    int border, border2;
  ...
  class RCDDemosaicProc
  {
  public: 
    void render(VipsRegion** in, int n, int in_first,
								VipsRegion* imap, VipsRegion* omap, 
								VipsRegion* out, RCDDemosaicPar* par)
    {
  ...
  class RCDDemosaicProc< OP_TEMPLATE_IMP_TYPE_SPEC(float) >
  {
  public: 
    void render(VipsRegion** in, int n, int in_first,
								VipsRegion* imap, VipsRegion* omap, 
								VipsRegion* out, RCDDemosaicPar* par)
    {
      ...
      rawimg.set_image_data( par->get_image_data() );
			rawimg.rcd_demosaic( in[0], out );
    }
  };


  ProcessorBase* new_rcd_demosaic();
}
