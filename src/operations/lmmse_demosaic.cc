...
PF::LMMSEDemosaicPar::LMMSEDemosaicPar():
  OpParBase()
{
...
VipsImage* PF::LMMSEDemosaicPar::build(std::vector<VipsImage*>& in, int first,
				     ...
				     unsigned int& level)
{
  ...
  if( vips_crop(in[0], &t[i0], 0, 1, in[0]->Xsize, border, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_crop(#1) failed"<<std::endl;
    return NULL;
  }
  //PF_UNREF( in[0], "LMMSEDemosaicPar::build(): in[0] unref #1" );
  // Flip the band vertically
  if( vips_flip(t[i0], &t[i0+1], VIPS_DIRECTION_VERTICAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_flip(#1) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0], "LMMSEDemosaicPar::build(): t[i0] unref #1" );
  // Put the vertical band above the original image
  if( vips_join(t[i0+1], in[0], &t[i0+2], VIPS_DIRECTION_VERTICAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_join(#1) failed"<<std::endl;
    return NULL;
  }
  //PF_UNREF( in[0], "LMMSEDemosaicPar::build(): in[0] unref #1-2" );
  PF_UNREF( t[i0+1], "LMMSEDemosaicPar::build(): t[i0+1] unref #1" );
  ...
  if( vips_crop(in[0], &t[i0], 0, in[0]->Ysize-border-1, in[0]->Xsize, border, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_crop(#2) failed"<<std::endl;
    return NULL;
  }
  //PF_UNREF( in[0], "LMMSEDemosaicPar::build(): in[0] unref #2" );
  // Flip the band vertically
  if( vips_flip(t[i0], &t[i0+1], VIPS_DIRECTION_VERTICAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_flip(#2) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0], "LMMSEDemosaicPar::build(): t[i0] unref #2" );
  // Put the vertical band below the previously joined image
  if( vips_join(t[i0-1], t[i0+1], &t[i0+2], VIPS_DIRECTION_VERTICAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_join(#2) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] unref #2" );
  PF_UNREF( t[i0+1], "LMMSEDemosaicPar::build(): t[i0+1] unref #2" );
  ...
  //PF_PRINT_REF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] refcount before crop" );
  if( vips_crop(t[i0-1], &t[i0], 1, 0, border, t[i0-1]->Ysize, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_crop(#3) failed"<<std::endl;
    return NULL;
  }
  //PF_PRINT_REF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] refcount after crop" );
  //PF_UNREF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] unref #3" );
  // Flip the band horizontally
  if( vips_flip(t[i0], &t[i0+1], VIPS_DIRECTION_HORIZONTAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_flip(#3) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0], "LMMSEDemosaicPar::build(): t[i0] unref #3" );
  ...
  if( vips_join(t[i0+1], t[i0-1], &t[i0+2], VIPS_DIRECTION_HORIZONTAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_join(#3) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] unref #3-2" );
  PF_UNREF( t[i0+1], "LMMSEDemosaicPar::build(): t[i0+1] unref #3" );
  ...
  if( vips_crop(t[i0-1], &t[i0], t[i0-1]->Xsize-border-1, 0, border, t[i0-1]->Ysize, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_crop(#4) failed"<<std::endl;
    return NULL;
  }
  //PF_UNREF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] unref #4" );
  // Flip the band horizontally
  if( vips_flip(t[i0], &t[i0+1], VIPS_DIRECTION_HORIZONTAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_flip(#4) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0], "LMMSEDemosaicPar::build(): t[i0] unref #4" );
  // Put the vertical band right of the previously joined image
  if( vips_join(t[i0-1], t[i0+1], &t[i0+2], VIPS_DIRECTION_HORIZONTAL, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_join(#4) failed"<<std::endl;
    return NULL;
  }
  PF_UNREF( t[i0-1], "LMMSEDemosaicPar::build(): t[i0-1] unref #4-2" );
  PF_UNREF( t[i0+1], "LMMSEDemosaicPar::build(): t[i0+1] unref #4" );
  ...
  if( vips_copy(t[i0+2], &extended, NULL) ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_copy(#1) failed"<<std::endl;
    return NULL;
  }
  //PF_UNREF( in[0], "LMMSEDemosaicPar::build(): in[0] after vips_copy()" );
  PF_UNREF( t[i0+2], "LMMSEDemosaicPar::build(): t[i0+2] after vips_copy()" );
  ...
  PF_UNREF( extended, "LMMSEDemosaicPar::build(): extended unref" );
  if( !img ) return NULL;
  ...
  PF_UNREF( img, "LMMSEDemosaicPar::build(): img unref" )
  if( result ) {
    std::cout<<"LMMSEDemosaicPar::build(): vip_crop() failed"<<std::endl;
    return NULL;
  }
  /**/
