...
echo "try $counter"
$HOME/inst/bin/crossroad install libtiff5 libtiff-devel libpng16-16 libpng-devel libjpeg8 libjpeg8-devel libgtkmm-2_4-1 gtkmm2-devel liborc-0_4-0 liborc-devel libexpat1 libexpat-devel win_iconv win_iconv-devel liblcms2-2 liblcms2-devel libxml2-2 libxml2-devel libxml2-tools libfftw3-3 fftw3-devel libexif12 libexif-devel  
