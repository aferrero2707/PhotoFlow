...
cd vips-8.4.5 && $HOME/inst/bin/crossroad configure --disable-gtk-doc --disable-gtk-doc-html --disable-introspection --enable-debug=yes --without-python --without-magick --without-libwebp && make -j 3 && make install
if [ $? -ne 0 ]; then exit 1; fi
